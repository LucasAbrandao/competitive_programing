...
void solve() {
  int a,b,c,d,qa,qb;
    ...
    if(a >= qa && b>=qb){
        ...
        else if(b>=qa && d>=qa && a+c>=qb){
            cout<<"S\n";
        }
        else if(b>=qa && c>=qa && a+d>=qb){
            cout<<"S\n";
        }
        else if(a>=qa && d>=qa && b+c>=qb){
            cout<<"S\n";
        }
        else if(a >= qb && c>= qb && b+d >=qa){
            cout<<"S\n";
        }
        else if(b>=qb && d>=qb && a+c>=qa){
            cout<<"S\n";
        }
        else if(b>=qb && c>=qb && a+d>=qa){
            cout<<"S\n";
        }
        else if(a>=qb && d>=qb && b+c>=qa){
            cout<<"S\n";
        }
        else{
            cout<<"N\n";
