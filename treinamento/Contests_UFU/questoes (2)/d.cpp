...
const int MAX = 1e6+10; // 10^6 + 10
    ...
    double areaTroncoCone (int b, int B, double vol){

        double h;

        h = (vol*3)/(M_PI * (b*b + B*B + b*B));
...
void solve() {
    ...
    int qntPessoas, aguaMl;

    cin >> qntPessoas >> aguaMl;

    int b,B,hMax;

    cin >> b >> B >> hMax;

    cout << areaTroncoCone(b,B,(double)(aguaMl/qntPessoas)) << endl;
